...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LIV");
    case mBTC: return QString("mLIV");
    case uBTC: return QString::fromUtf8("μLIV");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LiviaCoins"));
    case mBTC: return QString(QObject::tr("Milli-LiviaCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LiviaCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
