...
unsigned int nStakeMinAge = 2 * 24 * nOneHour; // 2 days as zero time weight
...
const string strMessageMagic = "LiviaCoin Signed Message:\n";
...
{
    int64_t nSubsidy = 666 * COIN;
	
	if (nHeight == 1)
		return 240000000 * COIN;
...
{
    int64_t nRewardCoinYear = 44 * CENT;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("LiviaCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in LiviaCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // LiviaCoin: check proof-of-stake block signature
...
bool CBlock::AcceptBlock()
{
    ...
    // Don't accept blocks with future timestamps after block 50000
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LiviaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Genesis of LiviaCoin";
        CTransaction txNew;
        txNew.nTime = 1470019014;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1470019017;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3850377; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb4, 0xc8, 0xe4, 0xe5 };
